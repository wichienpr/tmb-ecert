...
public class FeePaymentRequest implements Serializable {
	...
	private BigDecimal curAmt; // CurAmt.Amt
	private BigDecimal billPmtFee; // BillPmtFee
	...
	public BigDecimal getBillPmtFee() {
		return billPmtFee;
	}
	public void setBillPmtFee(BigDecimal billPmtFee) {
		this.billPmtFee = billPmtFee;
	}
